...
from wzone.myservices.myserv_connection_forblueprints import MongoCollection
...
def create_notification_from_ngb():
    ...
    # Initialize MongoCollection with pooling config
    notifylist_collection = MongoCollection(
        db_name="admin", 
        collection_name="mpwz_notifylist",
        max_pool_size=50,  # Customize as needed
        min_pool_size=10   # Customize as needed
    )
    ...
    app_exists = notifylist_collection.find_one({"app_name": application_type})
